...
#define BLUETOOTH_BUFFER_SIZE 3000
#define BLUETOOTH_BATTERY_SERVICE_STRING "AT+GATTADDSERVICE=UUID=0x180F\n"
#define BLUETOOTH_BATTERY_LEVEL_CHAR_STRING "AT+GATTADDCHAR=UUID=0x2A19,PROPERTIES=0x10,MIN_LEN=1,VALUE=100\n"
#define BLUETOOTH_ADVERTISING_STRING "AT+GATTSETADVDATA=02-01-06-03-02-0F-18\n"
