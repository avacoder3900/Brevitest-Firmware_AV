...
#define BLUETOOTH_ADD_STATUS_CODE_CHARACTERISTIC_STRING "AT+GATTADDCHAR=UUID=0x0003,DESCRIPTION=StatusCode,PROPERTIES=0x12,MIN_LEN=1,MAX_LEN=1,VALUE=0"
...
#define BLUETOOTH_ADD_CANCEL_TEST_CHARACTERISTIC_STRING "AT+GATTADDCHAR=UUID=0x0006,DESCRIPTION=CancelTest,PROPERTIES=0x1A,MIN_LEN=1,MAX_LEN=1,VALUE=F"
...
#define BLUETOOTH_ADD_ASSAY_DURATION_CHARACTERISTIC_STRING "AT+GATTADDCHAR=UUID=0x0009,DESCRIPTION=AssayDuration,PROPERTIES=0x12,MIN_LEN=1,MAX_LEN=2,VALUE=0"
