...
Resources:
Uses Wire1.h for i2c operation
...
Modified 2018 by Leo Linbeck III
...
//
//****************************************************************************//
LSM6DS3Core::LSM6DS3Core(uint8_t addr) : I2CAddress(0x6A) {
	I2CAddress = addr;
}
...
//
//****************************************************************************//
LSM6DS3::LSM6DS3(uint8_t addr) : LSM6DS3Core(addr) {
